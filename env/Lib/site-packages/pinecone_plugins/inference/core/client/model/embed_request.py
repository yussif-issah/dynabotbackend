...
class EmbedRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, model, inputs, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            parameters ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Additional model-specific parameters. Refer to the [model guide](https://docs.pinecone.io/guides/inference/understanding-inference#embedding-models) for available model parameters.. [optional]  # noqa: E501
        """
